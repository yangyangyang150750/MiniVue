...
function patchClass(el, newClass) {
  if (newClass === null) {
...
var ShapeFlags = /* @__PURE__ */ ((ShapeFlags3) => {
  ShapeFlags3[ShapeFlags3["ELEMENT"] = 1] = "ELEMENT";
  ShapeFlags3[ShapeFlags3["FUNCTIONAL_COMPONENT"] = 2] = "FUNCTIONAL_COMPONENT";
  ShapeFlags3[ShapeFlags3["STATEFUL_COMPONENT"] = 4] = "STATEFUL_COMPONENT";
  ShapeFlags3[ShapeFlags3["TEXT_CHILDREN"] = 8] = "TEXT_CHILDREN";
  ShapeFlags3[ShapeFlags3["ARRAY_CHILDREN"] = 16] = "ARRAY_CHILDREN";
  ShapeFlags3[ShapeFlags3["SLOTS_CHILDREN"] = 32] = "SLOTS_CHILDREN";
  ShapeFlags3[ShapeFlags3["TELEPORT"] = 64] = "TELEPORT";
  ShapeFlags3[ShapeFlags3["SUSPENSE"] = 128] = "SUSPENSE";
  ShapeFlags3[ShapeFlags3["COMPONENT_SHOULD_KEEP_ALIVE"] = 256] = "COMPONENT_SHOULD_KEEP_ALIVE";
  ShapeFlags3[ShapeFlags3["COMPONENT_KEPT_ALIVE"] = 512] = "COMPONENT_KEPT_ALIVE";
  ShapeFlags3[ShapeFlags3["COMPONENT"] = 6] = "COMPONENT";
  return ShapeFlags3;
})(ShapeFlags || {});
...
function createComponentInstance(vnode, parent) {
  const { data = () => {
  }, render: render2, props: propsOption = () => {
  } } = vnode.type;
...
function createRenderer(renderOptions2) {
  ...
  const setupReactiveEffect = (instance, container, anchor, parentComponent) => {
    const componentUpdateFn = () => {
      const { render: render3, m, bm, u, bu } = instance;
